...
### 🖼️ 2. 프로필 및 파일 관리 (Profile & File System)
* **이미지 파일 업로드:** 로컬 스토리지에 프로필 사진 및 게시물 이미지 저장 (`/files/profiles`, `/files/posts`)
